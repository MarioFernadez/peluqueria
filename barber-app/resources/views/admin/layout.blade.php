...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.appointments.index') }}" class="nav-item {{ request()->routeIs('admin.appointments.*') ? 'active' : '' }}" onclick="closeSidebar()">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="{{ route('admin.blocked_dates.index') }}" class="nav-item {{ request()->routeIs('admin.blocked_dates.*') ? 'active' : '' }}" onclick="closeSidebar()">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line><line x1="9" y1="15" x2="15" y2="15"></line>
            </svg>
            Excepciones
        </a>
...
<nav class="bottom-nav" aria-label="Navegación principal">
    <div class="bottom-nav-inner">
        ...
        <a href="{{ route('admin.appointments.index') }}" class="bottom-nav-item bottom-nav-center {{ request()->routeIs('admin.appointments.*') ? 'active' : '' }}">
